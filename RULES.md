...
6. Prefer standard-library implementations and local fixtures over external services.
7. Keep docs synchronized with actual code state; no milestone promotion without evidence.
8. Do not claim `full` closure unless every in-scope requirement row is validated.
